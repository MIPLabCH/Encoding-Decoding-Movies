...
trainset, valset, testset = get_dataset3(dataset_ID)
valset=testset
...
save_model_as = '/media/RCPNAS/MIP/Michael/students_work/rodrigo/temporal_decoder_' + str(mask_size) + '_' + str(num_epochs) + '_TRwindow' + str(window_size) + '_l1_' + str(lambda_l1) + '_ffaS01_datafrom_old_processed'
...
display_plots = True
save_plots = True
model_name = 'temporal_decoder_' + str(mask_size) + '_' + str(num_epochs) + '_TRwindow' + str(window_size) + '_l1_' + str(lambda_l1) + '_ffaS01_datafrom_old_processed'
