...
model, history = train_model_with_validation(
    train_input, train_label,           # Your regular training arrays
    valset['fMRIs'], valset['videos'],  # Validation dictionaries  
    model, num_epochs, lr, criterion, optimizer,
    batch_size, device, save_model_as, 
    pretrained_decoder, start_epoch, start_loss, model_to_train,
