...
model, history = train_model3(
    ...
    device=device,
    save_model_as="/media/RCPNAS/MIP/Michael/students_work/rodrigo/decoder_avg_and_subj1_4609_" + str(num_epochs),
#    save_model_as=save_model_as,
    model_to_train=model_to_train,  # or whichever part you're training
    display_plots=display_plots,
    save_plots=save_plots,
    model_name='decoder_avg_and_subj1_4609_' + str(num_epochs)
)
